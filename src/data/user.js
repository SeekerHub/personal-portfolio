...
const INFO = {
	...
	projects: [
...

		{
			title: "tvsLink",
			description:
				"A native mobile app supports both Android/IOS to authenticate customers, on submission of their id proof such as Aadhar, PAN cards etc built using React Native & OCR",
